    ...
    <nav class="grey lighten-1 menu hidden-print">
        <div class="nav-wrapper">
            <div class="col s12">
                ...
                <a href="{{ url('points/groupe') }}" class="breadcrumb">Points financiers</a>
                <a href="{{ url('points/groupe') }}" class="breadcrumb">Par groupe</a>
            </div>
        </div>
    </nav>
    ...
    <div style="margin-top: 30px; padding: 2%">
        <div class="row">
                ...
                <ul class="collapsible popout" data-collapsible="accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            {{ Form::open(['url'=>'/point/groupe','method'=>'post']) }}
                            <div class="row">
                                <div class="col s6">
            ...
            <div class="indigo-text lighten-4" style="padding: 1%">
                <?php if ($point_groupe == null && empty($erreurs)) {
                    echo '<p> Il n\'y a pas eu de vente de titres concernant cette période. </p>';
                } ?>
            </div>
            <div>
                <img align="right" style="padding-right: 2%; cursor: pointer;" src="{{URL::to('/')}}/img/imprimer.png" title="imprimer"
                     class="hidden-print"
                    ...
                    <div class="card-content">
                        <table class="maTable">
                            ...
                            <tr>
                                ...
                                <th colspan="2">Montant encaissé (en FCFA)</th>
                                <th rowspan="2">Total encaissé (TTC)</th>
