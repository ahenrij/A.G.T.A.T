...
@section('content')
    ...
    <nav class="grey lighten-1 menu">
        <div class="nav-wrapper">
            <div class="col s12">
                ...
                <a href="#!" class="breadcrumb">Création d'un utilisateur</a>
            </div>
        </div>
    </nav>
    ...
    <div class="row">
        <div class="col s12">
            {!! Form::open(['route' => 'user.store', 'class' => 'col s12','files' => true]) !!}
            <div class="card">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="input-field col m2 s12">
                                ...
                                <p class="small" style="margin-bottom: 10px">Photo de profil</p>
                                ...
                                <img id="preview" class="grey lighten-2 card hoverable" title="Cliquez pour en définir"
                                     onclick="$('#profil').click()" style="height: 150px; width: 150px"
                                     src="{{ profil_link('') }}" alt="Photo de profil"/>
                            </div>

                            <div class="input-field col m4 s12" style="margin-top: 160px">
                                <i class="material-icons prefix">person_outline</i>
                                <?php
                                $class = $errors->has('nom') ? 'invalid validate' : 'validate';
                                echo Form::text('nom', null, ['class' => "$class", 'id' => 'nom']);
                                ?>
                                <label for="nom"
                            ...
                            <div class="input-field col m6 s12" style="margin-top: 160px">
                                <i class="material-icons prefix"></i>
                                <?php
                                $class = $errors->has('prenom') ? 'invalid validate' : 'validate';
                                echo Form::text('prenom', null, ['class' => "$class", 'id'=>'prenom']);
                                ?>
                                <label for="prenom"
                        ...
                        <div class="row">
                            <div class="input-field col m6 s12">
                                ...
                                echo Form::select('type_user_id', $type_users, null, ['class' => "$class", 'id' => 'c_user_type_id']);
                                ?>
                            ...
                            <div class="input-field col m6 s12">
                                ...
                                echo Form::select('groupe_id', $groupes, null, ['class' => "$class", 'id' => 'c_user_group_id']);
                                ?>
